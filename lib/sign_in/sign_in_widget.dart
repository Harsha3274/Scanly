                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      ...
                      image: Image.asset(
                        'assets/images/BG_Equiptment.png',
                      ).image,
                    ),
                  ),
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        fit: BoxFit.cover,
                        image: Image.asset(
                          'assets/images/signin-backgrouond.jpg',
                        ).image,
                      ),
                    ),
                    child: Column(
                      ...
                      children: [
                        Container(
                          ...
                          child: ClipRRect(
                            ...
                            child: Image.asset(
                              'assets/images/Screenshot_2024-10-27_at_9.01.47_AM.png',
                              width: 200.0,
                              height: 200.0,
                              fit: BoxFit.cover,
                            ),
                                        ...
                                        StreamBuilder<List<UserDetailsRecord>>(
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            List<UserDetailsRecord>
                                                registerUserDetailsRecordList =
                                                snapshot.data!;
                                            // Return an empty Container when the item does not exist.
                                            if (snapshot.data!.isEmpty) {
                                              return Container();
                                            }
                                            final registerUserDetailsRecord =
                                                registerUserDetailsRecordList
                                                        .isNotEmpty
                                                    ? registerUserDetailsRecordList
                                                        .first
